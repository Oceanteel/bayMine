    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
      <div className="max-w-7xl mx-auto">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="relative z-10 text-center">
                {/* Step Number Circle */}
                <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-gradient-to-r ${step.color} mb-4 sm:mb-6 mx-auto`}>
        ...
        <div className="text-center mt-10 sm:mt-12 lg:mt-16">
          <button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-3 text-base sm:px-10 sm:py-4 sm:text-lg lg:px-12 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
            Get Started Now
          </button>
        </div>
      </div>
