      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12 lg:mb-16">
          {benefits.map((benefit, index) => (
            <div 
              key={index}
              className="flex items-start space-x-4 p-6 bg-white rounded-2xl border border-gray-200 shadow-lg hover:border-green-400/50 transition-all duration-300"
            >
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 md:p-12 border border-gray-200">
