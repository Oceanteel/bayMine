        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a 
                href="#"
                className="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-colors duration-300"
              >
        ...
        <div className="border-t border-slate-800 pt-6 mt-6 sm:pt-8 sm:mt-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {paymentMethods.map((method, index) => (
              <div 
                key={index}
                className={`px-4 py-2 bg-slate-800 rounded-lg border border-slate-700 ${method.color} font-medium text-sm`}
              >
                {method.name}
              </div>
            ))}
