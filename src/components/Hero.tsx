        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105">
                VIEW CONTRACTS
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-700">
              ...
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-orange-400 mb-2">180+</div>
          ...
          <div className="relative">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg shadow-lg z-20">
              <div className="text-sm font-semibold">Daily Income</div>
              <div className="text-lg font-bold">$0.60+</div>
            </div>
            
            <div className="absolute -bottom-4 -left-4 bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2 rounded-lg shadow-lg z-20">
