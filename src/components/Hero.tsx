          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in-up-3 items-center">
              <a
                ...
                className="w-4/5 sm:w-auto bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 text-base sm:px-8 sm:py-4 sm:text-lg rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 text-center"
              >
                CREATE AN ACCOUNT
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-4/5 sm:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 text-base sm:px-8 sm:py-4 sm:text-lg rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-green-500/25 text-center"
              >
                VIEW CONTRACTS
              </a>
            </div>
