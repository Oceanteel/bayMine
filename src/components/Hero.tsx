      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in-up-1">
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 leading-relaxed animate-fade-in-up-2">
            ...
            {/* Key Stats */}
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6 pt-8 transition-all duration-300 hover:scale-102 hover:shadow-2xl animate-fade-in-up-4">
